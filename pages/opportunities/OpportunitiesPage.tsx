...
import { FaBriefcaseMedical, FaUserGraduate, FaLaptopMedical, FaStethoscope, FaBuilding, FaUsers } from 'react-icons/fa';
...
const OpportunitiesPage = () => {
  const opportunityCards = [
    ...
    {
      title: "Open to Work",
      desc: "Search verified radiographers available for jobs or internships, or register your profile to get hired.",
      link: "/opportunities/talent",
      icon: FaUsers,
      color: "teal",
