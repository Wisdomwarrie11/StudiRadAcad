              ...
              <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 flex gap-4 items-start shadow-sm">
                 ...
                 <div>
                    ...
                    <p className="text-xs text-amber-800 font-medium leading-relaxed">
                       Please verify the facility and performing your own due diligence before accepting any internship offer. StudiRad acts as a facilitator and will not be responsible for any disputes or issues that may arise. By applying, you agree to our <Link to="/terms" className="underline font-bold">Terms of Service</Link>.
                    </p>
                 </div>
              </div>
